...
require (
	...
	github.com/aws/etcdadm-bootstrap-provider v1.0.13
	...
	github.com/nutanix-cloud-native/cluster-api-provider-nutanix v1.4.0
	...
	github.com/tinkerbell/cluster-api-provider-tinkerbell v0.5.3
	...
	sigs.k8s.io/cluster-api-provider-vsphere v1.10.1
